...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (username) {
        ...
        if (savedResumeData) {
            ...
            (document.getElementById('firstName') as HTMLInputElement).value = resumeData.name.split(' ')[0];
            (document.getElementById('lastName') as HTMLInputElement).value = resumeData.name.split(' ')[1];
